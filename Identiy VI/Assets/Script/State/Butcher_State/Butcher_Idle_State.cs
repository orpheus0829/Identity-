...
public class Butcher_Idle_State : Istate
{
    public Butcher rb_bt;
    public Butcher_AI ab_bt;
    public Animator am;
    public Rigidbody2D rb;
    public Butcher_Idle_State(Butcher bt)
    {
        rb_bt = bt;
        am = bt.am;
        rb = bt.rb;
    }
    public Butcher_Idle_State(Butcher_AI bt)
    {
        ab_bt = bt;
        am = bt.am;
        rb = bt.rb;
    ...
    public void OnUpdate()
    {
        ...
        if (ab_bt)
        {
            ...
            {
                ab_bt.Transition_State_B(Butcher_State_Type.walk);
            }
        ...
        if (rb_bt)
        {
            if (rb_bt.inputMove_B != Vector2.zero)
            {
                rb_bt.Transition_State_B(Butcher_State_Type.walk);
            }
